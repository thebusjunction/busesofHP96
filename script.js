    ...
    return `
      <article class="route-card" data-route-id="${route.id}">
        ...
        <div class="card-actions-row">
          <a href="#tabHelplines" data-target-tab="tabHelplines" class="btn-card-inquire" title="View Bus Stand Enquiry Contacts">
            <i class="fa-solid fa-phone-volume text-neon-green"></i> Depot Enquiry
          </a>
  ...
  container.innerHTML = filtered.map(route => {
    return `
      <article class="route-card long-card" data-route-id="${route.id}">
        ...
        <div class="card-actions-row">
          <a href="https://www.hrtchp.com" target="_blank" rel="noopener noreferrer" class="btn-card-inquire" style="border-color: var(--cyan-primary); color: var(--cyan-primary);" title="Official HRTC Ticket Booking Portal">
            <i class="fa-solid fa-ticket"></i> HRTC Online Booking
          </a>
